  ...
  return (
    <header className="py-8 bg-[#073F77]/5">
      ...
      <div className="w-[90%] mx-auto lg:flex md:flex justify-between hidden">
        <img src={logo} alt="Usedy" className="w-[235px] h-[43px]" />
        <nav>
          <NavLink
            to="/"
        ...
        {!isConnected ? (
          <button
            className="bg-[#154A80] rounded-lg p-3 text-white font-montserrat mr-4 text-[18px]"
            onClick={() => open()}
          >
            Connect Wallet
          </button>
        ) : (
          // Updated: w3m-button → appkit-button
          <appkit-button />
        )}
      </div>
      ...
      <div className="w-[95%] mx-auto flex justify-between lg:hidden md:hidden relative">
        <img src={logo} alt="Usedy" className="w-[185px] h-[43px]" />
        <Hamburger
          toggled={isOpen}
          toggle={setOpen}
          color="#154A80"
        ...
        />
        {isOpen && (
          <nav className="flex flex-col bg-white p-8 py-12 h-[100vh] w-full absolute top-20 left-0 bg-baseBlack/70 z-50">
            <NavLink
              to="/"
            ...
            <div className="mt-6">
              {!isConnected ? (
                <button
                  className="bg-[#154A80] rounded-lg p-4 text-white font-montserrat mr-4 text-[18px]"
                  onClick={() => open()}
                >
                  Connect Wallet
                </button>
